...
export const office:Words[] = [
  {
    ...
    englishTranscription : "ˈæplɪkənt",
    level : 1,
    id : 4,
    ...
    level : 1,
    idTheme : 4,
    ukrainianTranslation : "рекомендація",
    englishWord : "reference",
    ukrainianTranslationOfSentence : "Чи можете ви надати мені рекомендацію?",
    synonyms : ["endorsement"],
    englishTranscription : "ˈrefrəns",
  ...
  },
  {
    ...
    ukrainianTranslation : "мати багато справ",
    englishWord : "to have a lot on",
    idTheme : 4
  }, {
    level : 1,
    idTheme : 4,
