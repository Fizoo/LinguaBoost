...
export const feelings:Words[] = [
  {
    ...
    idTheme : 5,
    ukrainianTranslation : "Очікування"
  }, {
    ...
    englishTranscription : "kəˈmɪtmənt",
    ...
    idTheme : 5,
    englishTranscription : "kəmˌjunɪˈkeɪʃən",
    level : 1,
    ...
    level : 1,
    synonyms : ["agreement", "settlement", "negotiation"],
    idTheme : 5
  }, {
    ...
    level : 1,
    englishTranscription : "dɪˈvoʊʃən"
  },
  {
    ...
    level : 1,
    englishTranscription : "/ɡʊd taɪmz/"
  }, {
    englishTranscription : "/ˈɡrætɪtjuːd/",
    ukrainianTranslation : "Вдячність",
    idTheme : 5,
    id : 31,
  ...
  },
  {
    ...
    level : 1,
    englishWord : "laughter",
    synonyms : ["amusement", "mirth", "hilarity"],
    id : 41,
    ...
    synonyms : ["attentiveness", "hearing", "receptiveness"],
    id : 42,
    ...
    ukrainianTranslation : "Самотність",
    ...
    idTheme : 5,
    synonyms : ["affection", "adoration", "passion"],
    id : 44,
    englishWord : "love",
    ...
    englishTranscription : "/nɑːˈstældʒə/",
    idTheme : 5,
    level : 1,
    ...
    idTheme : 5,
    id : 50,
    ukrainianTranslation : "партнерство"
  }, {
    idTheme : 5,
    ...
    synonyms : ["forbearance", "endurance", "perseverance"]
  }, {
    level : 1,
    ukrainianTranslation : "Мир",
    englishTranscription : "/piːs/",
    ...
    id : 53,
    level : 1,
    synonyms : ["Mutual exchange", "give and take", "cooperation"],
  ...
  },
  {
    ...
    synonyms : ["Gentleness", "affection", "care"],
    englishWord : "tenderness"
  }, {
    ...
    englishTranscription : "/ɡɛt ˈmærɪd/",
    level : 1,
    id : 68,
