...
export const wordGeneral: Words[] = [
  {
    ...
    englishTranscription: "æz ˈmɛni ˈæz",
    level: 1,
    ...
    englishTranscription: "ˈdefənɪtli"
  }, {
    level: 1,
  ...
  {
    ukrainianTranslation: "кожен, всі",
    ...
    ukrainianTranslation: "користь, послуга",
    englishTranscription: "ˈfeɪvə",
    idTheme: 1,
    id: 24,
    englishWord: "favour",
    level: 1,
    englishSentence: "Can you do me a favour and pick up my dry cleaning?",
    ukrainianTranslationOfSentence: "Чи можете ви мені допомогти і забрати моє сухе чистування?"
  }, {
    englishWord: "fewer",
    ...
    level: 1,
    englishSentence: "Can you please forward this email to everyone on the team?",
    ukrainianTranslationOfSentence: "Чи можете ви, будь ласка, переслати цей електронний лист всім на команді?",
    synonyms: ["ahead", "send on"],
    id: 27,
    englishTranscription: "ˈfɔːwəd",
    ukrainianTranslation: "вперед, переслати",
    englishWord: "forward",
    idTheme: 1
  }, {
    ...
    ukrainianTranslationOfSentence: "Чи є поруч продуктовий магазин?",
    ukrainianTranslation: "поруч, близько",
    synonyms: ["close", "adjacent"],
    id: 38,
    englishTranscription: "ˈnɪəbaɪ",
    idTheme: 1,
    level: 1,
    englishWord: "nearby",
    englishSentence: "Is there a grocery store nearby?"
  }, {
    englishWord: "next to",
    idTheme: 1,
  ...
  },
  {
    ...
    englishWord: "overall",
    id: 41,
    englishTranscription: "ˈəʊvərɔːl",
    level: 1,
    idTheme: 1
  }, {
    ...
    id: 44,
    synonyms: ["potential", "feasible"],
    ukrainianTranslationOfSentence: "Чи можливо прибути раніше?",
    level: 1,
    englishWord: "possible",
    idTheme: 1,
    englishSentence: "Is it possible to arrive early?",
    englishTranscription: "ˈpɒsəbl",
    ...
    ukrainianTranslationOfSentence: "Чи можете ви дати мені деякі поради?",
    englishSentence: "Can you give me some advice?",
    level: 1,
    englishWord: "some",
    id: 53,
    ukrainianTranslation: "деякі",
    synonyms: ["a few", "certain"],
    ...
    ukrainianTranslation: "конкретно",
    idTheme: 1,
    level: 1,
    ...
    englishWord: "suggest",
    englishSentence: "Can you suggest a good book to read?",
    id: 57,
    englishTranscription: "səˈdʒest",
    idTheme: 1,
    level: 1,
    ukrainianTranslationOfSentence: "Чи можете ви запропонувати хорошу книгу для читання?",
  ...
  },
  {
    ...
    idTheme: 1,
    level: 1,
    synonyms: ["we", "our", "me and you"],
    englishSentence: "Can you give us more information?",
    ukrainianTranslationOfSentence: "Чи можете ви надати нам більше інформації?",
    englishTranscription: "ʌs",
    ukrainianTranslation: "нас, нам",
    englishWord: "us",
    id: 65
  }, {
  ...
  },
  {
    ...
    level: 1,
    englishTranscription: "ʌnprɪˈdɪktəbl"
  }, {
    ukrainianTranslation: "головним чином",
    idTheme: 3,
    id: 83,
  ...
  {
    ukrainianTranslationOfSentence: "Він зробив дурну помилку на екзамені.",
    level: 1,
    englishWord: "silly",
    id: 84,
    ukrainianTranslation: "дурний",
    englishSentence: "He made a silly mistake in the exam.",
    synonyms: ["foolish", "ridiculous", "goofy"],
    englishTranscription: "ˈsɪli",
    idTheme: 1
  }, {
    englishTranscription: "ɪnˈkrɛdəbli",
    idTheme: 1,
    englishSentence: "The view from the top of the mountain is incredibly beautiful.",
    id: 85,
    synonyms: ["extremely", "unbelievably"],
    englishWord: "incredibly",
    ukrainianTranslation: "неймовірно",
    ukrainianTranslationOfSentence: "Вид з вершини гори неймовірно красивий.",
    level: 1
  }, {
    id: 86,
    ukrainianTranslation: "в наші дні",
    englishTranscription: "ˈnaʊədeɪz",
    idTheme: 1,
    level: 1,
    englishSentence: "Nowadays, people rely heavily on technology for communication.",
    ukrainianTranslationOfSentence: "В наші дні люди сильно покладаються на технології для зв'язку.",
    synonyms: ["currently", "presently"],
    englishWord: "nowadays"
  }, {
    level: 1,
    ukrainianTranslationOfSentence: "Їжа мала неприємний смак.",
    englishTranscription: "ʌnˈplɛznt",
    englishSentence: "The food had an unpleasant taste.",
    idTheme: 1,
    id: 87,
    synonyms: ["disagreeable", "offensive"],
    englishWord: "unpleasant",
    ukrainianTranslation: "неприємний"
  }, {
    ukrainianTranslation: "справа, матерія",
    englishTranscription: "ˈmætər",
    englishSentence: "Money is not the only matter that concerns him.",
    synonyms: ["affair", "concern", "substance"],
    englishWord: "matter",
    id: 88,
    ukrainianTranslationOfSentence: "Гроші - не єдина справа, яка турбує його.",
    level: 1,
    idTheme: 1
  }, {
    englishWord: "probably",
    ...
    englishTranscription: "ˈprɒbəbli",
    level: 1,
    ukrainianTranslationOfSentence: "Ймовірно, вона прибуде пізно.",
    id: 89,
    idTheme: 1,
    englishSentence: "She will probably arrive late."
  }, {
    englishTranscription: "ˈfluːəntli",
    id: 90,
    idTheme: 1,
    ukrainianTranslationOfSentence: "Він розмовляє англійською мовою бігло.",
    englishWord: "fluently",
    level: 1,
    ukrainianTranslation: "бігло, плавно",
    englishSentence: "He speaks English fluently.",
    synonyms: ["smoothly", "eloquently"]
  }, {
    englishTranscription: "ɪnˈstɛd",
    ukrainianTranslationOfSentence: "Вона хотіла чаю, але замість цього подали каву.",
    englishSentence: "She wanted tea, but they served coffee instead.",
    idTheme: 1,
    id: 91,
    ...
    synonyms: ["choice", "determination"],
    ukrainianTranslationOfSentence: "Прийняття рішення може бути складним.",
    englishWord: "decision",
    englishTranscription: "dɪˈsɪʒn",
    id: 92,
    ukrainianTranslation: "рішення",
    level: 1,
    idTheme: 1,
    englishSentence: "Making a decision can be difficult."
  }, {
    idTheme: 1,
    level: 1,
    ...
    englishWord: "walk",
    englishSentence: "We decided to take a walk in the park.",
    ukrainianTranslationOfSentence: "Ми вирішили прогулятися в парку.",
    id: 93,
    ukrainianTranslation: "йти, прогулянка"
  }, {
    ukrainianTranslation: "натхнення",
    englishWord: "inspiration",
    level: 1,
    idTheme: 1,
    ukrainianTranslationOfSentence: "Картина була створена з великим натхненням.",
    englishSentence: "The painting was created with great inspiration.",
    englishTranscription: "ˌɪnspɪˈreɪʃn",
    synonyms: ["creativity", "motivation"],
    id: 94
  }
]
